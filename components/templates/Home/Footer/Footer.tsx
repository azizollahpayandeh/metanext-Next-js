          ...
          <div className="alllTable flex justify-around mt-[100px] ">
            ...
            <div className="flex flex-col gap-[25px]">
              ...
              <div className="flex flex-row items-center">
                <Image
                width={25}
                height={30} src="/Images/Group 70202.png" alt="" />
              ...
              <div className="flex flex-row items-center">
                <Image
                width={25}
                height={30} src="/Images/Group 70202 (1).png" alt="" />
                <p className="text-[#7E8AAB] text-[18px] font-[400] cursor-pointer">
                  {" "}
                  مدیریت نیروی کار
                </p>
              ...
              <div className="flex flex-row items-center">
                <Image
                width={25}
                height={30} src="/Images/Group 70202 (2).png" alt="" />
                <p className="text-[#7E8AAB] text-[18px] font-[400] cursor-pointer">
                  {" "}
                  گفتوگو با مشتریان
                </p>
              ...
              <div className="flex flex-row items-center">
                <Image
                width={25}
                height={30} src="/Images/Group 70202 (3).png" alt="" />
                <p className="text-[#7E8AAB] text-[18px] font-[400] cursor-pointer">
                  {" "}
                  اپلیکیشن فروشگاهی{" "}
                </p>
              ...
              <div className="flex flex-row items-center">
                <Image
                width={25}
                height={30} src="/Images/Group 70202 (4).png" alt="" />
                <p className="text-[#7E8AAB] text-[18px] font-[400] cursor-pointer">
                  {" "}
                  سایت فروش{" "}
                </p>
